...
var EnglishTranslator = map[string]string{
	...
	RouteNamesFlagUsage:                        "only output timetables for routes with the specified comma-separated `route names`",
	...
	OperationModeNamesFlagName:                 "O",
	OperationModeNamesFlagUsage:                "only output timetables for modes of operation with the specified comma-separated `operation mode names`",
