...
var BulgarianTranslator = map[string]string{
	Usage: "употреба: %s [-л кодове на линии] [-т типове превозни средства] [-с кодове на спирки] [-покажиВреме] [-покажиУсловия] [-сортирайСпирки] [имена на спирки]\n" +
		"          %s -покажиСпирки [-сортирайСпирки]\n" +
		"          %s -покажиМаршрути [-л кодове на линии] [-т типове превозни средства] [-сортирайСпирки]\n" +
		"\n" +
