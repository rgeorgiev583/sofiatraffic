...
var BulgarianTranslator = map[string]string{
	...
	Usage: "употреба: %s [-л номера на линии] [-т типове превозни средства] [-с кодове на спирки] [-м кодове на маршрути] [-р кодове на режими] [-покажиВреме] [-покажиУсловия] [-покажиМаршрут] [-покажиРежим] [-използвайРазписание] [-сортирайСпирки] [-преведиИменаНаСпирки] [имена на спирки]\n" +
		...
		"Ако е подаден опционалният аргумент `-покажиЛинии`, програмата просто ще изведе списък със всички линии (групирани по тип на превозното средство) и ще приключи.\n" +
